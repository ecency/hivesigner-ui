...
export default class Sign extends Vue {
  ...
  private mounted (): void {
    ...
    if (!this.authority && this.parsed && this.parsed.tx) {
      ...
      this.hasRequiredKey = !!(
        AuthModule.username && ((this.authority === 'active' && (AuthModule.keys['owner'] || AuthModule.keys['active'])) || (this.authority === 'posting' && (AuthModule.keys['owner'] || AuthModule.keys['active'] || AuthModule.keys['posting'])) || AuthModule.keys[this.authority])
      )
    }
  }
