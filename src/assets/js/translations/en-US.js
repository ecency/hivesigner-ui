const USVAL = {
  common: {
    ...
    no: "No",
    invalid_integrity:
      'This website most likely phishing attempt. Please make sure to use <a class="underline" href="https://hivesigner.com" target="_blank" rel="noopener">hivesigner.com</a> only.',
    logged_in: "Logged In",
    decrypted: "Decrypted",
    encrypted: "Encrypted",
  },
  ...
  import: {
    ...
    password_placeholder:
      "Hive private key, e.g. Owner, Active, Posting, Memo keys",
  ...
  login: {
    ...
    hs_password_confirmation_required:
      "Hivesigner password confirmation is required",
  ...
  developers: {
    ...
    2: {
      ...
      message:
        "You can edit your app settings by updating your app account profile.",
